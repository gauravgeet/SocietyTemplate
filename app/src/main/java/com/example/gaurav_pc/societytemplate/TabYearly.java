...
public class TabYearly extends Fragment {
    ImageView imageViewAddExpense;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab_yearly, container, false);
        ...
        String[] ExpenseArray = {"Apartment Coloring","New Community Hall","Dinner","Garden Maintenance"};
    ...
    private void setOnExpenseClick() {
        imageViewAddExpense.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getContext(),AddYearlyExpenses.class);
